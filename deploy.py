"""
deploy.py - GitHub auto push（ピックル公開リポジトリ用）

配置: C:\\Users\\tenni\\fukuoka-pick\\deploy.py
実行: python deploy.py

このフォルダ（fukuoka-pick）の変更を git add / commit / push する。
generate_html_auto.py から呼ばれる（docs/ をコピー後に実行）。
公開URL: https://hiro-ito1.github.io/fukuoka-pick/
"""
import subprocess
import sys
...
def main():
    ...
    print("=" * 70)
    print("deploy.py: GitHub auto push（ピックル）")
    print("=" * 70)
    ...
    print("=" * 70)
    print("Done! 2-3分で反映:")
    print("  https://hiro-ito1.github.io/fukuoka-pick/")
    print("=" * 70)
